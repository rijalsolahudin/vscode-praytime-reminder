...
- **Adzan Reminders:**
  - **5 minutes before adzan:** A popup appears with a countdown and notification sound.
  - **At adzan time:** A popup appears with prayer info and the adzan audio plays automatically.
...
5. **At prayer times,** popups will appear to remind you, and the adzan audio will play automatically.
